...
@Component({
  selector: 'licky-lick-marketing-features5',
  templateUrl: './lick-marketing-features5.component.html',
  styles: []
})
export class LickMarketingFeatures5Component implements OnInit {
