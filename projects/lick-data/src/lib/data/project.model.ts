...
export class Project  {
  ...
  static restoreData(data: any): void {
    ...
    data.projectType = data.hasOwnProperty('projectType') ? data.projectType : null;
    ...
    data.milestones = data.hasOwnProperty('milestones') ? data.milestones : [];
    data.requirements = data.hasOwnProperty('requirements') ? data.requirements : [];
    data.affectedParties = data.hasOwnProperty('affectedParties') ? data.affectedParties : [];
    data.implementationPlans = data.hasOwnProperty('implementationPlans') ? data.implementationPlans : [];
    data.affectedSystems = data.hasOwnProperty('affectedSystems') ? data.affectedSystems : [];
    data.approvals = data.hasOwnProperty('approvals') ? data.approvals : [];

    data.sponsor = data.hasOwnProperty('sponsor') ? data.sponsor : null;
    data.sponsorType = data.hasOwnProperty('sponsorType') ? data.sponsorType : null;
    data.summaryOfBudget = data.hasOwnProperty('summaryOfBudget') ? data.summaryOfBudget : null;
    data.projectManager = data.hasOwnProperty('projectManager') ? data.projectManager : null;
    data.projectManagerName = data.hasOwnProperty('projectManagerName') ? data.projectManagerName : null;
    data.responsibilities = data.hasOwnProperty('responsibilities') ? data.responsibilities : null;
    data.purpose = data.hasOwnProperty('purpose') ? data.purpose : null;
    ...
    data.percentTimeComplete = data.hasOwnProperty('percentTimeComplete') ? data.percentTimeComplete : 0;
...
export class Requirement {
  ...
  static restoreData(data: any): void {
    ...
    data.project_id = data.hasOwnProperty('project_id') ? data.project_id : null;
    data.description = data.hasOwnProperty('description') ? data.description : null;
    data.requirementStatus = data.hasOwnProperty('requirementStatus') ? data.requirementStatus : null;
...
export class Deliverable {
  ...
  static restoreData(data: any): void {
    ...
    data.project_id = data.hasOwnProperty('project_id') ? data.project_id : null;
    data.deliverableStatus = data.hasOwnProperty('deliverableStatus') ? data.deliverableStatus : null;
...
export class AffectedParty {
  ...
  static restoreData(data: any): void {
    ...
    data.project_id = data.hasOwnProperty('project_id') ? data.project_id : null;
    data.description = data.hasOwnProperty('description') ? data.description : null;
    data.affectedPartyType = data.hasOwnProperty('affectedPartyType') ? data.affectedPartyType : null;
...
export class Bug {
  ...
  static restoreData(data: any): void {
    ...
    data.description = data.hasOwnProperty('description') ? data.description : null;
    data.currentState = data.hasOwnProperty('currentState') ? data.currentState : null;
    data.proposedSolution = data.hasOwnProperty('proposedSolution') ? data.proposedSolution : null;
    data.bugStatus = data.hasOwnProperty('bugStatus') ? data.bugStatus : null;
    data.publishedAt = data.hasOwnProperty('publishedAt') ? data.publishedAt : null;
...
export class ProjectReport {
  ...
  static restoreData(data: any): void {
    ...
    data.project_id = data.hasOwnProperty('project_id') ? data.project_id : null;
    data.report_version = data.hasOwnProperty('report_version') ? data.report_version : null;
    data.status = data.hasOwnProperty('status') ? data.status : null;
...
export class Approval  {
  ...
  static restoreData(data: any): void {
    ...
    data.approvalDate = data.hasOwnProperty('approvalDate') ? data.approvalDate : null;
    data.approver = data.hasOwnProperty('approver') ? data.approver : null;
    data.approverName = data.hasOwnProperty('approverName') ? data.approverName : null;
