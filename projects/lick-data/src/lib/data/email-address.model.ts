...
export class EmailAddress {
  ...
  static restoreData(data: any): void {
    ...
    data.emailAddress = data.hasOwnProperty('emailAddress') ? data.emailAddress : null;
    data.emailAddressType = data.hasOwnProperty('emailAddressType') ? data.emailAddressType : null;
    ...
    data.blocked = data.hasOwnProperty('blocked') ? data.blocked : false;
