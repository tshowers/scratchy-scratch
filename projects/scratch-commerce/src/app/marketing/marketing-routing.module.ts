...
const routes: Routes = [
  ...
  { path: 'shop', component: ShopProductGridPageComponent, data: { title: 'Shop Page - 16 AHEAD - eCommerce' } },
  ...
  { path: 'products', component: ShopProductListPageComponent, data: { title: 'Products - 16 AHEAD - eCommerce' } },
