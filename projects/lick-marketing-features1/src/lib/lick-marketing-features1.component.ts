...
@Component({
  selector: 'licky-lick-marketing-features1',
  templateUrl: './lick-marketing-features1.component.html',
  styles: []
})
export class LickMarketingFeatures1Component implements OnInit {
