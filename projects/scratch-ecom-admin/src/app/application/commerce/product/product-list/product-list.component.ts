...
export class ProductListComponent extends LickAppPageComponent implements OnInit, OnDestroy, LickAppBehavior {
  ...
  setBreadCrumb(): void {
    this.crumbs = [
      ...
      { name: "products", link: "/stores/" + this.store_id + "/catalogs/" + this.catalog_id + "/products", active: true },
      { name: "new", link: "/stores/" + this.store_id + "/products/new", active: false },
    ]
  }
  ...
  onNewItem() : void {
    this.router.navigate([ 'stores', this.store_id, 'catalogs', this.catalog_id, 'products', 'new']);
  }
  ...
  onDetail(data): void {
    this.router.navigate([ 'stores', this.store_id, 'catalogs', this.catalog_id, 'products',  data.id])
  }

  onEdit(data): void {
    this.router.navigate([ 'stores', this.store_id, 'catalogs', this.catalog_id, 'products', data.id, 'edit'])
  }
