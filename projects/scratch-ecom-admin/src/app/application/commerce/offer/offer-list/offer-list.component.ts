...
export class OfferListComponent extends LickAppPageComponent implements OnInit, OnDestroy, LickAppBehavior {
  ...
  setBreadCrumb(): void {
    this.crumbs = [
      ...
      { name: "offers", link: "/stores/" + this.store_id + "/catalogs/" + this.catalog_id + "/offers", active: false },
      { name: "new", link: "/stores/" + this.store_id + "/catalogs/" + this.catalog_id + "/offers/new", active: false },
    ]
  }
  ...
  onNewItem() : void {
    this.router.navigate([ 'stores', this.store_id, 'catalogs', this.catalog_id, 'offers', 'new']);
  }
  ...
  onDetail(data): void {
    ...
    this.router.navigate([ 'stores', this.store_id, 'catalogs', this.catalog_id, 'offers',  data.id])
  }

  onEdit(data): void {
    this.router.navigate([ 'stores', this.store_id, 'catalogs', this.catalog_id, 'offers', data.id, 'edit'])
  }
