...
@Component({
  selector: 'licky-lick-app-widget-product-list',
  templateUrl: './lick-app-widget-product-list.component.html',
  styles: []
})
export class LickAppWidgetProductListComponent implements OnInit {
  ...
  @Input() products: Product[] = [
    {
      ...
      "url": "https://via.placeholder.com/720x949",
