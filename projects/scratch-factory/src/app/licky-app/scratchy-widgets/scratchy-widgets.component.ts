...
@Component({
  selector: 'app-scratchy-widgets',
  templateUrl: './scratchy-widgets.component.html',
  styleUrls: ['./scratchy-widgets.component.css']
})
export class ScratchyWidgetsComponent implements OnInit {
